...
if(NOT QWT_LIBRARY)
    EXECUTE_PROCESS( COMMAND find /usr/lib64/ -type f -name "*qwt-qt5*" COMMAND tr -d '\n' OUTPUT_VARIABLE QWT_LIBRARY )
...
set(QWT_INCLUDES_NAMES qwt-qt5 qwt6-qt5 qwt qwt6)
...
IF (QWT_FOUND)
  ...
  IF (NOT QWT_FIND_QUIETLY)
    MESSAGE(STATUS "Looking for qwt: ${QWT_LIBRARY} (${QWT_VERSION_STR})")
  ENDIF (NOT QWT_FIND_QUIETLY)
ELSE (QWT_FOUND)
  IF (QWT_FIND_REQUIRED)
    MESSAGE(FATAL_ERROR "Looking for qwt: not found")
